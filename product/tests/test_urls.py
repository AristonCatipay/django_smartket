...
from product.views import update_customer_number, add_product, edit_product, delete_product, metric, add_metric, edit_metric, delete_metric, category, add_category, edit_category, delete_category, color, add_color, edit_color, delete_color, size, add_size, edit_size, delete_size
...
class TestUrls(TestCase):
    ...
    def test_index_url(self):
        ...
        self.assertEqual(resolve(url).func, update_customer_number)
